...
// ── Tablas propias del season-service ─────────────────
model Temporada {
  id          Int     @id @default(autoincrement())
  numero      Int
  nombre      String  @db.VarChar(150)
